view: farol {
  ...
  dimension: proc_status_13_aluno_pendente_matricula_dentro {
    type: number
    label: "Status 13.0 - Dentro do SLA %"
    description: "Alunos pendente de matricula"
    sql: ${TABLE}."PROC_STATUS_13_ALUNO_PENDENTE_MATRICULA_DENTRO" ;;
  }

  dimension: proc_status_14_possui_divida_dentro {
    type: number
    label: "Status 14.0 - Dentro do SLA %"
    description: "Alunos pendente de matricula"
  ...
  dimension: proc_status_15_aluno_revertido_nova_analise_ies_dentro {
    type: number
    label: "Status 15.0 - Dentro do SLA %"
    description: "Alunos revertidos para nova análise IES"
