            ...
            FROM
                ...
                FROM
                    ...
                    FROM
                        ...
                        WHERE (solucx."STORE_NAME") = 'Relacional' AND (solucx."RATING_COMMENT") <> 'False' AND (solucx."CLASS_NOTA") = 'NEUTRO' AND (((solucx."TIMESTAMP") >= ((DATE_TRUNC('year', CURRENT_DATE()))) AND (solucx."TIMESTAMP") < ((DATEADD('year', 1, DATE_TRUNC('year', CURRENT_DATE())))))) AND (((( solucx."RATING_TIMESTAMP")) IS NOT NULL))
                        GROUP BY
                            1
                        ORDER BY
                            1
