view: inep {
  ...
  dimension: ds_mob_acad_intern {
    type: string
    group_label: "Aluno"
    label: "Intercâmbio Acadêmico - Interno"
  ...
  measure: curso_qtd_vaga_total {
    ...
    sql: ${curso_qtd_vagas.med_vaga_total} ;;
  ...
  measure: curso_qtd_vaga_anual_ead {
    ...
    sql: ${curso_qtd_vagas.med_vaga_anual_ead} ;;
  ...
  measure: curso_qtd_vaga_anual_integral {
    ...
    sql: ${curso_qtd_vagas.med_vaga_anual_integral} ;;
  ...
  measure: curso_qtd_vaga_anual_noturno {
    ...
    sql: ${curso_qtd_vagas.med_vaga_anual_noturno} ;;
  ...
  measure: curso_qtd_vaga_anual_vespertino {
    ...
    sql: ${curso_qtd_vagas.med_vaga_anual_vespertino} ;;
  ...
  dimension: tp_financiamento {
    ...
    measure: carga_horaria {
      type: average
      group_label: "Curso"
      label: "Carga Horária"
      sql: ${carga_horaria_curso.avg_carga_horaria} ;;
