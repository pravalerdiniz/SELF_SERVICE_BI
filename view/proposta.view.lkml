view: proposta {
  ...
  measure: count_contratos_cedidos{
    ...
    drill_fields: [id_cpf, id_proposta,flg_contrato_ativo,flg_contrato_cedido,data_concessao_date,id_contrato_conjunto,tipo_proposta,perc_tx_subsidiado_ies,perc_desagio,tx_mensal_total,tx_mensal_aluno,tx_anual_total]
