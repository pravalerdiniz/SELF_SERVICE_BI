view: jornada_interacoes_pago {
 ...
 ;;
  ...
  dimension:  flag_social{
    ...
    label: "Flag de Impacto - Canal Pago"
    description: "Flag que aponta se o aluno teve impacto do canal Pago na jornada nos últimos 180 dias"
  }
