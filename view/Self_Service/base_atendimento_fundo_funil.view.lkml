...
view: base_atendimento_fundo_funil {
  ...
  dimension: flg_consultor_fundo_funil {
    ...
    type: yesno
    sql: ${TABLE}."LOGIN" IN
        ('ANDERSON.OLIVEIRA','ANDREZA.SILVA','ARYELLY.PEQUENO','BRUNO.NICOLETI','DANNY.SILVA',
        'DENISE.OLIVEIRA','GABRIELLY.ANDRADE','INGRID.SANTOS','JULIANA.AZEVEDO','KAUANY.SABINO',
        'MARCELLA.SANTOS','NATHALYA.MARTINS','SHAIRON.WEINBERG','WESLEY.DALBERIO','MAGDA.SOARES',
        'KARLA.SANTOS','KELLY.ALMEIDA','LETICIA.SOUSA','IZADORA.BOMEISEL','GABRIEL.BARCELOS',
        'DANIELE.PETRORENZO','LUANA.CUCATO') ;;
  }
