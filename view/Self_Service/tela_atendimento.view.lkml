...
'NATHALYA.MARTINS.LUANDRE','MARCELLA.SANTOS','JULIANA.AZEVEDO','JIANINI.FIGUEIREDO.LUANDRE',
'WESLEY.DALBERIO','ANDERSON.OLIVEIRA.LUANDRE','DENISE.OLIVEIRA.LUANDRE',
'BEATRIZ.MORAES','BRUNO.NICOLETI.LUANDRE','SABRINA.RODRIGUES','VITOR.BOARINI', 'BRUNO.OLIVEIRA',
'FELIPE.SANTOS', 'KAUANY.SABINO', 'DANNY.SILVA', 'BRUNO.NICOLETI')
      ;;
  }
