view: tela_atendimento {
  ...
  derived_table: {
    sql: select * from GRADUADO.CRM.CHAMADOS_TELA_ATENDIMENTO
        where login in ('ARYELLY.PEQUENO','DANNY.SILVA.LUANDRE','INGRID.SANTOS',
'NATHALYA.MARTINS','MARCELLA.SANTOS','JULIANA.AZEVEDO','JIANINI.FIGUEIREDO.LUANDRE',
'WESLEY.DALBERIO','BEATRIZ.MORAES','SABRINA.RODRIGUES','VITOR.BOARINI',
'BRUNO.OLIVEIRA', 'FELIPE.SANTOS', 'KAUANY.SABINO', 'DANNY.SILVA', 'BRUNO.NICOLETI',
'ANDERSON.OLIVEIRA', 'DENISE.OLIVEIRA', 'ANDREZA.SILVA', 'SHAIRON.WEINBERG', 'GABRIELLY.ANDRADE',
'MAGDA.SOARES', 'DANIELE.PETRORENZO', 'GABRIEL.BARCELOS', 'IZADORA.BOMEISEL', 'LEONARDO.RODRIGUES',
'LEONARDO.SENA', 'LUANA.CUCATO', 'RICARDO.GUANABENS', 'LETICIA.SOUSA', 'KARLA.SANTOS', 'DIEGO.OLIVEIRA',
'KELLY.ALMEIDA')
      ;;
  }
