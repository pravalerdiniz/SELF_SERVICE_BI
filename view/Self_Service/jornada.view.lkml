...
dimension: flg_d1 {
  ...
  dimension: ciclo_aprov_behavior {
    ...
    sql: case when ${dt_aprovado_behavior_date} between '2021-06-01' and '2021-10-31' then '2021.2'
              ...
              when ${dt_aprovado_behavior_date} between '2022-12-01' and '2023-05-31' then '2023.1'
              else 'Outro' end;;
  }
...
dimension: flag_balcao {
  ...
  dimension: flag_afiliados {
    type: yesno
    sql: case when ${aluno_cpf} in (select distinct cpf_lead from "GRADUADO"."BALCAO_AFILIADOS"."LEADS") then 'Yes' else 'No' end ;;
