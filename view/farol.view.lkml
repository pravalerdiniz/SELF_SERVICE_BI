...
dimension: tempo_status {
  ...
  dimension: total_status_fora_renovacao {
    ...
    sql: CASE WHEN sum(${TABLE}."STATUS_2006_0_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2002_0_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2011_1_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2011_5_FORA") = 0 THEN 1 ELSE 0 END+
...
CASE WHEN sum(${TABLE}."STATUS_2031_5_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2035_0_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2034_1_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2034_0_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2041_1_FORA") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2006_1") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2006_2") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2007_5") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2010_1") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2000_0") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2009_0") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2033_2") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2044_1") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2044_2") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2043_0") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2084_1") = 0 THEN 1 ELSE 0 END+
CASE WHEN sum(${TABLE}."STATUS_2099") = 0 THEN 1 ELSE 0 END
 ;;
