...
CASE WHEN ${TABLE}."STATUS_2007_2_FORA" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2007_6_FORA" = 0 THEN 1 ELSE 0 END+
...
CASE WHEN ${TABLE}."STATUS_2014_1_FORA" = 0 THEN 1 ELSE 0 END+
...
CASE WHEN ${TABLE}."STATUS_2046_1_FORA" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2046_2_FORA" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2046_3_FORA" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2046_4_FORA" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2046_5_FORA" = 0 THEN 1 ELSE 0 END+
...
CASE WHEN ${TABLE}."STATUS_2040_0" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2042_1" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2042_2" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2042_3" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2042_4" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2044_1" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2044_2" = 0 THEN 1 ELSE 0 END+
CASE WHEN ${TABLE}."STATUS_2044_3" = 0 THEN 1 ELSE 0 END+
 ...
 ;;
    ...
    hidden: yes
          ...
          measure: perc_okr_diario_renovacao {
            type: sum
            value_format: "0.0%"
            sql: ${total_status_fora_renovacao}/44 ;;
