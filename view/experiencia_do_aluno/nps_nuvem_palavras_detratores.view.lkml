            ...
            FROM
                ...
                FROM
                    ...
                    FROM
                        ...
                        WHERE (solucx."STORE_NAME") IN ('ALUNOS FORMADOS - RELACIONAL', 'ALUNOS NOVOS - RELACIONAL', 'ALUNOS RENOVAÇÃO - RELACIONAL', 'Relacional') AND (solucx."RATING_COMMENT") <> 'False' AND (solucx."CLASS_NOTA") = 'PROMOTOR' AND (solucx."TIMESTAMP") >= ((DATE_TRUNC('year', CURRENT_DATE()-180))) AND (((( solucx."RATING_TIMESTAMP")) IS NOT NULL))
                        GROUP BY
                            1
                        ORDER BY
                            1
