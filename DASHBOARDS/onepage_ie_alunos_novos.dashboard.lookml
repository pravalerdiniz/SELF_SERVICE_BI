- dashboard: onepage_ie__alunos_novos
  title: OnePage IE - Alunos Novos
  layout: newspaper
  ...
  - name: Tela da IE
    ...
    subtitle_text: Alunos parados na tela de avaliação da IE por status
    body_text: ''
    row: 0
    col: 0
    width: 24
  ...
  - title: Pendentes de matrícula
    ...
    filters:
      ...
      alunos.ultimo_status_proposta: '13.0'
      proposta.tipo_proposta: NOVO
      alunos.tipo_produto: "-FIES,-INTERCAMBIO"
      proposta.grupo_instituicao: ''
      proposta.ds_instituicao: ''
  ...
  - title: Outras pendências
    ...
    filters:
      alunos.id_status_geral: ''
      alunos.ultimo_status_proposta: 13.10,13.11,13.12,13.13,13.16,13.3
      proposta.tipo_proposta: NOVO
      alunos.tipo_produto: "-FIES,-INTERCAMBIO"
      proposta.grupo_instituicao: ''
      proposta.ds_instituicao: ''
    ...
    width: 6
    height: 2
  - title: Inexistentes na IE
    name: Inexistentes na IE
    model: self_service_bi
    explore: alunos
    type: single_value
    fields: [alunos.count_id_cpf]
    filters:
      alunos.id_status_geral: ''
      alunos.ultimo_status_proposta: '13.1'
      proposta.tipo_proposta: NOVO
      alunos.tipo_produto: "-FIES,-INTERCAMBIO"
      proposta.grupo_instituicao: ''
      proposta.ds_instituicao: ''
  ...
  - title: Pendentes por desconto
    ...
    filters:
      alunos.id_status_geral: ''
      alunos.ultimo_status_proposta: '13.14'
      proposta.tipo_proposta: NOVO
      alunos.tipo_produto: "-FIES,-INTERCAMBIO"
      proposta.grupo_instituicao: ''
      proposta.ds_instituicao: ''
    ...
    width: 6
    height: 2
  - title: Quantidade de Alunos Novos Cedidos por Mês
    name: Quantidade de Alunos Novos Cedidos por Mês
    model: self_service_bi
    explore: jornada
    type: looker_line
    ...
    width: 20
    height: 6
  - name: Funil de Alunos Novos
    type: text
    title_text: Funil de Alunos Novos
    subtitle_text: Quantidade de alunos novos por etapa do funil e conversão
    body_text: ''
    row: 27
    col: 0
    width: 24
    height: 2
  - name: Alunos Novos Cedidos e Valores de Repasse
    type: text
    title_text: Alunos Novos Cedidos e Valores de Repasse
    subtitle_text: Quantidade de alunos novos que foram cedidos por mês e valores
      repassados
    body_text: ''
    row: 11
    col: 0
  ...
  - title: Funil 2021
    ...
    filters:
      jornada.etapa: Finalizado,Aprovado Risco,Aprovado Instituicao,Aguardando Documento,Aguardando
  ...
  - title: '2021'
    ...
    width: 4
    height: 2
  - title: Valor de Repasse de Alunos Novos por Mês
    name: Valor de Repasse de Alunos Novos por Mês
    model: self_service_bi
    explore: financeiro
    type: looker_column
  ...
  - title: Média em dias dos alunos parados
    ...
    filters:
      jornada.etapa_ultimo_status: Tela da Instituição
      jornada.status_etapa: '1'
      jornada.tipo_proposta: NOVO
  ...
  - title: SLA Médio de Aprovação dos Alunos pela IE
    ...
    explore: jornada
    type: looker_column
    fields: [jornada.dt_status_month, jornada.media_aprovado_instituicao_novos]
