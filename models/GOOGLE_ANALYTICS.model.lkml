...
explore: ga_campanha_ads_cost {
  ...
  join: google_analytics {
    ...
    and ${ga_overview_campanha.date_date} = ${google_analytics.date_date};;
  ...
  join: ga_overview_campanha {
    ...
    and ${ga_campanha_ads_cost.campanha} = ${ga_overview_campanha.campanha}
    ...
    and ${ga_campanha_ads_cost.id_grupo_anuncio} = ${ga_overview_campanha.id_grupo_anuncio};;
